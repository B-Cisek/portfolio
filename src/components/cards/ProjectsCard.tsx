...
function GitHubIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 438.549 438.549" className={className} aria-hidden="true">
      <path
        fill="currentColor"
          ...
          >
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              {currentProject.tags.map((tag) => (
                <span
                  key={tag}
                  className="rounded-md border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] font-medium text-slate-300 uppercase"
                >
                  {tag}
                </span>
              ))}
